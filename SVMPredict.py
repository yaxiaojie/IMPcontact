...
class Predict:
    ...
    def svmpredict(self, filename, filepath):
        ...
        cmd = 'svm-predict -b 1 ' + filepath + ' /home/jiayj267/IMP/experiment/randSample29.model /home/jiayj267/IMP/experiment/0.7rand/predictresult/' + pdbid + '.result'
        os.system(cmd)
